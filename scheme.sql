...
USE reminder_list;
 ...
 CREATE TABLE items(id_message TINYINT auto_increment PRIMARY KEY, message VARCHAR(100), datetime_reminder datetime, id_list TINYINT, FOREIGN KEY(id_list) REFERENCES lists (id_list));
